...
import com.dr.udaan.ui.ModelSlider

class AdapterCurrentNews(  private val viewPager2: ViewPager2, var list: ArrayList<ModelSlider>) :
    RecyclerView.Adapter<AdapterCurrentNews.ViewHolder>() {
